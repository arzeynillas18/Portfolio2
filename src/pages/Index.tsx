        ...
        <section className="py-20 md:py-32 flex items-center">
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-12">
              <div className="md:w-1/2 space-y-6 animate-fade-in">
                ...
                <p className="text-lg text-muted-foreground max-w-xl">
                  ...
                  usability, performance, and visual appeal. My focus is on
                  delivering seamless digital experiences that work for
                  everyone.
                </p>
            ...
            <div className="flex justify-center mt-20">
              <a
                href="#about"
                className="animate-bounce rounded-full p-1 bg-muted/50"
              >
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex flex-wrap gap-2 mb-8">
                ...
                <Button
                  variant={
                    activeCategory === "frontend" ? "default" : "outline"
                  }
                  size="sm"
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            <div className="flex flex-col gap-4 mb-10">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl">
                ...
                crafted to solve a specific problem or meet a particular need.
              </p>
            </div>
...
"
                >
                  <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-slate-600 rounded-md group-hover:bg-opacity-0">
